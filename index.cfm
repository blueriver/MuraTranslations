...
<cfhtmlhead text='<link rel="stylesheet" href="#application.configbean.getContext()#/admin/css/tab-view.css" type="text/css" media="screen">'>
<cfhtmlhead text='<script type="text/javascript" src="#application.configbean.getContext()#/admin/js/tab-view.js"></script>'>
<cfoutput><script type="text/javascript">
initTabs(Array("Settings","Template Code","About this Plugin"),#attributes.activeTab#,0,0);
</script></cfoutput>