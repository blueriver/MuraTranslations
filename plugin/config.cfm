...
<cfsilent>
	...
	<cfset cfcPath="plugins." & pluginConfig.getDirectory() & ".cfcs">
	<cfset translationManager=createObject("component","#cfcPath#.translationManager").init(application.configBean,pluginConfig)>
</cfsilent>